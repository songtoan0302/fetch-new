...
public class VNCharacterUtils {
	...
	private final char[] SOURCE_CHARACTERS = { 'À', 'Á', 'Â', 'Ã', 'È', 'É', 'Ê', 'Ì', 'Í', 'Ò', 'Ó', 'Ô', 'Õ', 'Ù',
			...
			'ừ', 'Ử', 'ử', 'Ữ', 'ữ', 'Ự', 'ự','Ỹ', 'ỹ','Ỵ','ỵ','Ỷ','ỷ' };

	private final char[] DESTINATION_CHARACTERS = { 'A', 'A', 'A', 'A', 'E', 'E', 'E', 'I', 'I', 'O', 'O', 'O', 'O',
	...
	public String removeSpecialCharacter(String s) {
		...
		return removeAccent(s).trim().replaceAll(" +", " ").replaceAll("[^\\w\\.]", "_").replaceAll("_+", "_");
	}
}